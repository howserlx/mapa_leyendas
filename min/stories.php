    ...
    <div class="modal-dialog">
      <div class="modal-content leyenda_modal_background">
            ...
            <div id="modal_map_leyenda_text_container" class="col-md-12 leyenda_modal_text_container">
              ...
              <div id="modal_map_leyenda_share_block">
                ...
                <div class="form-group">
                    ...
                    <button id="share_url_clipboard" type="button" class="btn btn-raised legitRipple btn-info" ><i class="icon-copy4"></i> Copiar al portapapeles</button>
                    <a id="modal_map_leyenda_share_url" href="" target="_blank" type="button" class="btn bg-purple legitRipple"><i class="icon-link"></i> Ir al Link</a>
        ...
        <div class="modal-footer">
          <br/>
          <a id="modal_map_leyenda_prev" href="" class="btn btn-default bg-grey-300 text-grey-800 float-left"><i class="icon-circle-left2"></i></a>
          <a id="modal_map_leyenda_next" href="" class="btn btn-default bg-grey-300 text-grey-800 float-left"><i class="icon-circle-right2"></i></a>

          <button id="modal_map_leyenda_share" href="" type="button" class="btn bg-purple-400"><i class="icon-share3"></i> Comparte esta Leyenda</button>
          <button type="button" class="btn btn-default bg-grey-300 text-grey-800" data-dismiss="modal"><i class="icon-cross2"></i> Cerrar</button>
