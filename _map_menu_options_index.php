<!-- layer menu options -->
<ul id="uxmap_controls" class="fab-menu fab-menu-absolute fab-menu-top-left" data-fab-toggle="click" data-fab-state="open">
	<li>
		...
		<ul class="fab-menu-inner">
			...
			<li>
				<div data-fab-label="<?php echo $lang['MENU_SHARE']; ?>">
					<a id="uxmap_c_share_map" class="btn btn-white rounded-pill btn-icon btn-float" data-toggle="modal" data-target="#modal_map_share">
		...
		<li id="uxmap_c_exit_street_view_container" style="display:none">
		  <div data-fab-label="<?php echo $lang['MENU_GOOGLE_STREET_OFF']; ?>"> 
			<a id="uxmap_c_exit_street_view" class="d-none d-sm-block btn btn-danger uxmap_c_exit_street_view">
			  <i class="icon-arrow-left16"></i><i class="icon-map4"></i> <?php echo $lang['BACK']; ?>
			</a>
